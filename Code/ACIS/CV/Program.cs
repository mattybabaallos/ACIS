...
namespace Barcode_finder_Csharp
{
    class Program
    {
        ...
        static int LargestArea(VectorOfMat vectorOfMat)
        {
            double largest = 0;
            int index = 0;
            double area = 0;
        ...
        static Mat Stitch_image_h(Mat img1, Mat imgT, Size img1_size, Size imgT_size, Point max_loc, int new_temp_h, int size_to_crop)
        {
            ...
            Console.WriteLine("max_loc.y:" + max_loc.Y);
            Console.WriteLine("size to crop:" + size_to_crop);
        ...
        static void Main(string[] args)
        {
            ...
            */
            ...
            var overlap = 0.65;         //amount of overlap for the photos  
            var seg_R = 3;              //number of rows
            var seg_C = 4;              //number of colums

            var path = "C:/Users/Kestutis/Documents/PSU/Images/Image_stitching";
            ...
            for(int k=0; k<seg_R; k++)
            {
                ...
                for (int y = 0; y < seg_C - 1; y++)
                {
                    ...
                    size_to_crop = size_to_crop + max_loc.X;
                    imageResult = Stitch_image_w(img1, imgT, img1_size, imgT_size, max_loc, new_temp_h, size_to_crop);
            ...
            for(int x=0; x<seg_R-1; x++)
            {
                ...
                imageResult = Stitch_image_h(img1, imgT, img1_size, imgT_size, max_loc, img_size.Height, size_to_crop);
